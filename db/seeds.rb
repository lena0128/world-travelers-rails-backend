...
City.create([
    ...
    summary: "Where things happen, and travelers enjoy having a taste of that excitement.",
    content: "There are so many elements that make New York City one of the best cities in the world. The city and the Statue of Liberty that travelers see as they arrive is symbolic of the culture and freedom that America stands for. The Big Apple is the financial hub of the United States, with Wall Street and international businesses.
    ...
    summary: "There is never a lack of intrigue or interest in London.",
    content: "There is never a lack of intrigue or interest in London as a destination which is makes it one of the most touristic cities in the world. The Royal intrigue is one of its main draws, as thousands of tourists descend on Buckingham Palace to get a brush with the British monarchy.
    ...
    summary: "Bangkok has a lively atmosphere, even during the daylight hours.",
    content: "The bustling city of Bangkok, Thailand is one of the top tourist cities in the world, with nearly 24.1 million visitors a year. The city is usually the first stopping point for anyone touring through Thailand. Bangkok has an exciting mix of packed subways, huge skyscrapers, temples, historic architecture, lavish gardens, palaces, and almost nightly sporting events, like kickboxing, that draw thousands of fans.
    ...
    summary: "Hong Kong is a convenient holiday destination, and its shopping, especially for bargains, is unmatched.",
    content: "Hong Kong is one of the most famous cities in the world. It has remained so for more than a decade and continues to attract travelers. With an estimated 29.2 million visitors a year, the city has a stronghold over other cities in the world when it comes to attracting travelers. Hong Kong is a convenient holiday destination, and its shopping, especially for bargains, is unmatched.
    ...
    summary: "The culture of Rome and its historic architecture are its main draws.",
    content: "Rome is one of those destinations that sits on many travelers' must-see someday lists. The culture of Rome and its historic architecture are its main draws. The Colosseum, Pantheon, Trevi fountain, and the Vatican usually top the list of things vacationers want to check off their list.
...
Guide.create([
    {
        title: " I Love Paris!",
        body: "This is a very nice palce!",
        city_id: "1"
    }
])
